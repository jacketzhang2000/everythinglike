...
public class FileMeta {
    ...
    public FileMeta(String name,String path,Boolean isDirectory,Long size,Date lastModified){
        ...
        if(PinyintUtil.containsChinese(name)){
           String[] pinyins=PinyintUtil.get(name);
           pinyin=pinyins[0];
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, meta.name) &&
                ...
                Objects.equals(pinyin, meta.pinyin) &&
                Objects.equals(pinyinFirst, meta.pinyinFirst);
    }

    @Override
    public int hashCode() {

        return Objects.hash(name, path, size, lastModified, isDirectory, sizeText, lastModifiedText, pinyin, pinyinFirst);
    }
